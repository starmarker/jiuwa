<template>
	<div class="main">
		...
		<div class="container">
			...
			<van-field v-model="sign_info.user_name" type="text" placeholder="请输入参赛者姓名" required />
		</div>
		<div class="container">
			<div class="field-title van-hairline--bottom">参赛宣言</div>
			<van-field v-model="sign_info.declaration" type="textarea" placeholder="请输入参赛宣言" rows="4" autosize class="text-area" />
		</div>
...
<style>
	...
	.van-cell .van-cell__value:hover{
